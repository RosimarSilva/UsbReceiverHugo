...
- {pin_num: '35', pin_signal: LCD_P0/ADC0_SE8/PTB0/LLWU_P5/I2C0_SCL/TPM1_CH0/SPI1_MOSI/SPI1_MISO, label: Analog, identifier: Analog}
...
- pin_list:
  ...
  - {pin_num: '35', peripheral: ADC0, signal: 'SE, 8', pin_signal: LCD_P0/ADC0_SE8/PTB0/LLWU_P5/I2C0_SCL/TPM1_CH0/SPI1_MOSI/SPI1_MISO}
...
void BOARD_InitPins(void)
{
    ...
    PORT_SetPinMux(BOARD_INITPINS_Analog_PORT, BOARD_INITPINS_Analog_PIN, kPORT_PinDisabledOrAnalog);
